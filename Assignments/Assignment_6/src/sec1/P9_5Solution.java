...
//import PA6.*;   // Use Appointment and its subclasses from PA6
import java.io.*;
import java.util.*;


public class P9_5Solution {
            ...
            while (!done) {
                ...
                switch (option) {
                    ...
                    case 'c':
                        ...
                        printOccurs(appointments.toArray(apps), year, month, day); // Use method from PA6                        break;                    case 'q':                        done = true;                        break;                    default:                        System.out.println("Invalid option.");                        break;
                }
            }
        } catch (Exception e) {
     ...
     * * @param date        format: yyyy-mm-yy     * @param description
     */
