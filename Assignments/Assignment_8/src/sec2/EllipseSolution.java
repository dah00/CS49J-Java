...
public class EllipseSolution extends JComponent{
    public void paintComponent(Graphics g) {    /* overriding paintComponent of JComponent class and passing object g                                                   of type Graphics as an argument */
